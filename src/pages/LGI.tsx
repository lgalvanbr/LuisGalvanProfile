        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <div className="flex items-center gap-6">
            <a href="#lgi-hero" className="text-2xl font-bold font-sans text-white tracking-tight flex items-center gap-3">
              <img src="/logo_LGI.jpeg" alt="LGI Ingeniería Logo" className="h-10 w-auto rounded-md" />
      ...
      <main>
        ...
        <section id="lgi-hero" className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
          ...
          <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
            ...
            >
              <img src="/logo_LGI.jpeg" alt="LGI Ingeniería Logo" className="h-32 md:h-40 w-auto mx-auto rounded-2xl mb-8 shadow-[0_0_40px_rgba(0,123,255,0.2)] object-contain" />
      ...
      <footer className="bg-slate-950 py-12 border-t border-white/5 text-center text-slate-500">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between">
          <div className="flex items-center gap-3 mb-4 md:mb-0">
            <img src="/logo_LGI.jpeg" alt="LGI Logo" className="h-8 w-auto rounded-sm grayscale hover:grayscale-0 transition-all" />
